...
public class CAS2ClientException extends FrameworkClientException {
    ...
    protected CAS2ClientException(String errorDescription, String exceptionStatus, String exceptionMessage, String acsUrl) {
    ...
    public static CAS2ClientException error(String errorDescription, String exceptionStatus, String exceptionMessage, String acsUrl) {
        return new CAS2ClientException(errorDescription, exceptionStatus, exceptionMessage, acsUrl);
    }
